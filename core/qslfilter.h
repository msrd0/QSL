...
/// @file qslfilter.h This file contains the `qsl::QSLFilter` class and a lot of definitions to
 ...
 * must be of type `QSLFilterExprType`. There should not be a reason for
 * calling this method directly. Use the `filter` method generated by `qslc`
 * instead.
 * 
